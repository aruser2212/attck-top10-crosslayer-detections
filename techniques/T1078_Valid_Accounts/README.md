...
Админы, bastion/jump-hosts, CI/CD, backup и сервисные учётки будут шуметь. Для них нужны отдельные профили нормального поведения, а не тупой allow-list «лишь бы молчало». Самое ценное — первый новый источник для важного аккаунта.
